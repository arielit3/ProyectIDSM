...
# Problematica: 
Limitada accesibilidad a opciones alimenticias en la universidad.

# Descripcion del problema: 
La problematica que se busca solucionar se basa en la falta de un canal tecnologico centralizado y eficiente para la promocion y adquisicion de alimentos dentro de la universidad. Actualmente la mayoria de los estudiantes emprendedores dependen de grupos informales en redes sociales donde las publicaciones suelen perder visibilidad entre otros anuncions, esto limita tanto la oportunidad de compra como la oportunidad de venta.
